...
(sme:defsmetest "Simple heat/water analogy"
  ...
  (:mapping 1
   (:mh-count 11)
   (:score 3.1179998)
   (:entity-mhs ((pipe bar) (water heat) (beaker coffee) (vial ice-cube)))
   (:root-mhs
   ...
   (:root-mh-count 2)
   (:cis
    ((cause (greater (temperature coffee) (temperature ice-cube))
  ...
  (:mapping 2
            (:mh-count 11)
            (:score 3.1179998)
            (:entity-mhs ((beaker coffee) (vial ice-cube)
                          (water heat)(pipe bar)))
            (:root-mhs
...
(sme:defsmetest "Complex heat/water analogy"
  ...
  (:mapping 1
   ...
   (:score 810.056)
   (:entity-mhs
    ((fluid-flow heat-flow) (cs-v ice-cube) (pi pi) (cs-beak coffee)(pipe bar)))
   (:root-mhs
    (((prop (flow-rate pi) (diff pi)) (prop (flow-rate pi) (diff pi)))
...
(sme:defsmetest "Rutherford analogy"
  ...
  (:mapping 1
   (:mh-count 11)
   (:score 3.2250004)
   (:entity-mhs ((sun nucleus) (planet electron)))
   (:root-mhs
...
(sme:defsmetest "Syslit analogy 5"
  ...
  (:mapping 1
   ...
   (:score 3005.41)
   (:entity-mhs
    ((high high) (man1 gagrach) (karla zerdia)
     (feathers supercomputer) (f f) (cross-bow missiles)))
   (:root-mhs
    (((warlike man1) (warlike gagrach))
   ...
   (:root-mh-count 13)
   (:cis
    ((follow (see zerdia gagrach) (attack gagrach zerdia))
...
(sme:defsmetest "Syslit analogy 17"
  ...
  (:mapping 1
   ...
   (:score 75558.984)
   (:entity-mhs
    ((jones mrs-lee) (valley1 twenty-dollars1) (smith betty) (johnson norma)))
   (:root-mhs
    (((desirable valley1) (desirable twenty-dollars1))
...
(sme:defsmetest "Commutatives test 1"
  ...
  (:mapping 1
   (:mh-count 9)
   (:score 0.415)
   (:entity-mhs ((sally seth) (bill bob) (henry henrietta)))
   (:root-mhs
    (((and henry bill sally) (and seth bob henrietta))
     ((active bill) (active bob))
     ((authority henry) (authority henrietta))))
   (:root-mh-count 3)
   (:cis nil)))

(sme:defsmetest "Commutatives test 2"
  ...
  (:mapping 1
            (:mh-count 7)
            (:score 0.575)
            (:entity-mhs ((bob barbara) (bill biff) (sally simon)))
            (:root-mhs
             (((and bill bob) (and biff barbara))
  ...
  (:mapping 2
            (:mh-count 7)
            (:score 0.575)
            (:entity-mhs ((bill biff) (bob simon) (sally barbara)))
            (:root-mhs
             (((and bill bob) (and biff simon))
